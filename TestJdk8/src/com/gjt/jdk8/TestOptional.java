...
public class TestOptional {
    ...
    public static void main(String[] args) {
        ...
        //1. Optional.of - 如果传值的参数为 null，抛出异常 NullPointerException
        try {
        ...
        //2. Optional.ofNullable - 允许传值为 null 参数
        Integer value1 = null;
        ...
        //如果值不存在,返回hashcode=0
        System.out.println(emp.isPresent()+"  "+emp+"  "+emp.hashCode()+"   empty()=ofNullable(null): "+emp.equals(a));
        
        System.out.println(java8Tester.sum(a,b));

        //a=null, orElse和orElseGet相同; a!=null, orElse仍会执行get
        System.out.println("给定值=null时orElse orElseGet");
